...
const HomePage = () => {
  ...
  const pageStyles = {
    ...
    maxWidth: '600px',
    position: 'relative', // Ensure the parent div is positioned relative
    margin: '0 auto', // Center the page horizontally
    display: 'flex',
    flexDirection: 'column',
    alignItems: 'center',
    width: '100%', // Allow content to expand inside the max width
  };

  const consultancyListStyles = {
